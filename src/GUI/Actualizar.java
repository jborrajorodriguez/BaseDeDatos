...
public class Actualizar extends javax.swing.JFrame {
    ...
    public Actualizar() {
        ...
        this.setTitle("Actualizar Equipo");
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "nombre", "piloto1", "piloto2" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Funciones.conectar();
        Funciones.actualizarEquipo(campo,jTextField2.getText(), jTextField1.getText());
        Funciones.cerrar();
        jTextField1.setText("");
        jTextField2.setText("");
